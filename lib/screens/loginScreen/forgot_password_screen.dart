            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: headerContent(
                    titleName: StringConstant.forgotPasswordTitle,
                    fontSize: 6.w,
                ...
                centerContent(
                    titleName: StringConstant.forgotPassword,
                    description: StringConstant.forgotPasswordDescription,
                ...
                loginUIComponent(
                  forgotPasswordContent(
                      authController.emailController, context),
                ),
                SizedBox(
                  height: 6.h,
                ),
                CustomButtonWidget(
                  ...
                  onPressed: () async {
                    await Utils.firebaseAuth.sendPasswordResetEmail(
                        email: authController.emailController.text.trim());
                    Utils.showSnackBar("Password reset email sent. Please check your inbox.");
